...
--Insert Noticias
insert into PrimeraParte_ParteB.dbo.noticias(idNoticia, titulo, idCategoria, autor, fecha, ubicacion) values (0, 'Se robaron hasta el papel higenico', 0, 1, '01/07/2022', 'Chacarita')
insert into PrimeraParte_ParteB.dbo.noticias(idNoticia, titulo, idCategoria, autor, fecha, ubicacion) values (1, 'No dejaron ni los cordones', 0, 2, '11/03/2021', 'Neuquen')
go
